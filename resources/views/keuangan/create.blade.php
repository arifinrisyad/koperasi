...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Tambahkan transaksi keuangan baru</p>
        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis" id="pemasukan" value="pemasukan" {{ old('jenis') == 'pemasukan' ? 'checked' : '' }} required>
                                        <label class="form-check-label" for="pemasukan">
                                            Pemasukan
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis" id="pengeluaran" value="pengeluaran" {{ old('jenis') == 'pengeluaran' ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save fa-sm me-1"></i> Simpan
                                    </button>
                                </div>
                            </div>
                        </div>
